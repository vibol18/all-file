  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <form onSubmit={handleSubmit} className="bg-gray-200 w-[450px] p-8 shadow-sm rounded-lg">
        ...
        <button
          type="submit"
          className="w-full bg-blue-500 text-white h-10 rounded-lg hover:bg-blue-600 transition-colors"
        >
          Login
        </button>
        ...
        <div className="flex justify-center mt-4">
          <p>
            ...
            <Link to="/register" className="text-blue-500 hover:text-red-500">
              Register
            </Link>
          </p>
        </div>
